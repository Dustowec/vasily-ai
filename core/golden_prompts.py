        ...
        self._prompts = {
            "default": {
                ...
                "prompt": (
                    ...
                    "## CORE PRINCIPLES\n"
                    "1. **Think before acting**: Use <thinking> tags to plan your steps and reason about the user's intent.\n"
                    ...
                    "- BEFORE using `remember_fact`, you MUST call `recall_memory` with keywords from the fact.\n"
                    "- If `recall_memory` returns `found: true` and the existing fact already contains this information, DO NOT call `remember_fact`.\n"
                    "- Instead, reply to the user: 'Я уже знаю, что [факт], и не буду создавать дубликат в памяти.'\n"
                    "- ONLY use `remember_fact` for genuinely new information that is not in memory.\n\n"
            ...
            "analysis": {
                ...
                "prompt": (
                    ...
                    "with bullet points. Think step-by-step in <thinking> tags."
                ),
            },
            "summary": {
